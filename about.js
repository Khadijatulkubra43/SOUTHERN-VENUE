...
function animateCounters() {
    ...
    observer.observe(document.querySelector('.sustainability-content'));
}
...
newsletterForm.addEventListener('submit', function (e) {
    ...
    if (email) {
        this.innerHTML = '<div style="color: white; font-size: 16px; padding: 15px; background: rgba(0,0,0,0.2); border-radius: 10px;"><i class="fas fa-check-circle" style="color: #4CAF50; margin-right: 10px;"></i> Thank you for subscribing!</div>';
